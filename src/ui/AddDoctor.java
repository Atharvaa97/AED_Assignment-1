...
public class AddDoctor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        filteredList.setBackground(new java.awt.Color(238, 238, 238));
        filteredList.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        filteredList.setForeground(new java.awt.Color(238, 238, 238));
        ...
        patientLabel.setFont(new java.awt.Font("Lucida Fax", 1, 14)); // NOI18N
        patientLabel.setForeground(new java.awt.Color(255, 255, 255));
        patientLabel.setText("Select Doctor:");

        detailsPanel.setBackground(new java.awt.Color(11, 48, 56));
        detailsPanel.setForeground(new java.awt.Color(255, 255, 255));

        addVisit.setBackground(new java.awt.Color(0, 0, 0));
        addVisit.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        addVisit.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel26.setForeground(new java.awt.Color(238, 238, 238));
        ...
        visitPanel.setBackground(new java.awt.Color(11, 48, 56));
        ...
        addDoctorDetail.setBackground(new java.awt.Color(0, 0, 0));
        addDoctorDetail.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        addDoctorDetail.setForeground(new java.awt.Color(255, 255, 255));
        ...
        doctorIdentifierField.setBackground(new java.awt.Color(238, 238, 238));
        doctorIdentifierField.setForeground(new java.awt.Color(0, 0, 0));
        ...
        hospitalNameField.setBackground(new java.awt.Color(238, 238, 238));
        hospitalNameField.setForeground(new java.awt.Color(0, 0, 0));
        ...
        specializationField.setBackground(new java.awt.Color(238, 238, 238));
        specializationField.setForeground(new java.awt.Color(0, 0, 0));
        ...
        experienceField.setBackground(new java.awt.Color(238, 238, 238));
        ...
        visitPanelLayout.setVerticalGroup(
            ...
            .addGroup(visitPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(visitPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(hospitalNameField, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(1, 1, 1)
                        .addComponent(searchNameField, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
    ...
    public int getDoctorId() {
        int foundID = DoctorDirectory.doctorDirectory.size();
        for (int i = 0; i < DoctorDirectory.doctorDirectory.size(); i++) {
            if (DoctorDirectory.doctorDirectory.get(i).personDetails.personId == chosenPerson.personId) {
                System.out.println("--Already a patient");
                foundID = DoctorDirectory.doctorDirectory.get(i).doctorIdentifier;
            }
        }
    ...
    public Doctor getDoctor() {
        ...
        for (int i = 0; i < DoctorDirectory.doctorDirectory.size(); i++) {
            if (DoctorDirectory.doctorDirectory.get(i).personDetails.personId == chosenPerson.personId) {
                 found = DoctorDirectory.doctorDirectory.get(i);
            }
        }
        return found;
    }
    ...
    private void addDoctorDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addDoctorDetailActionPerformed
       ...
       Boolean isAlreadyADoctor = isAlreadyDoctor();
        ...
        if (!isAlreadyADoctor) {
            DoctorDirectory.doctorDirectory.add(chosenDoctor);
        }
        restVitals();
